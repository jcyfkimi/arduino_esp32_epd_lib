...
void setup()
{
  printf("EPD_2IN13_SE2213_test Demo\r\n");
  DEV_Module_Init();

  printf("e-Paper Init and Clear...\r\n");
  EPD_2IN13_SE2213_Init();
  EPD_2IN13_SE2213_Clear();
  DEV_Delay_ms(500);

  //Create a new image cache named IMAGE_BW and fill it with white
  UBYTE *BlackImage, *RYImage; // Red or Yellow
  UWORD Imagesize = ((EPD_2IN13_SE2213_WIDTH % 8 == 0) ? (EPD_2IN13_SE2213_WIDTH / 8 ) : (EPD_2IN13_SE2213_WIDTH / 8 + 1)) * EPD_2IN13_SE2213_HEIGHT;
  ...
  Paint_NewImage(BlackImage, EPD_2IN13_SE2213_WIDTH, EPD_2IN13_SE2213_HEIGHT, 270, WHITE);
  Paint_NewImage(RYImage, EPD_2IN13_SE2213_WIDTH, EPD_2IN13_SE2213_HEIGHT, 270, WHITE);
  ...
  EPD_2IN13_SE2213_Display(gImage_2in13c_b, gImage_2in13c_y);
  DEV_Delay_ms(2000);
#endif
  ...
  printf("EPD_Display\r\n");
  EPD_2IN13_SE2213_Display(BlackImage, RYImage);
  DEV_Delay_ms(2000);
#endif
